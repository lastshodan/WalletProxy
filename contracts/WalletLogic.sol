...
contract WalletLogic is Ownable, Pausable {
    ...
    */
    ...
    /**
    * @dev remove address of token we dont  need
    */
    ...
    * Transfer is pausable when need arises i.e incase of a bug being discovered in the contract
    */
    ...
    * only owner of wallet can withdraw
    * Withdrawal is pausable in case a vulnerability is discovered in the contract.
    */
